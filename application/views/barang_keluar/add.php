			    ...
			    <div class="col-md-8">
		            ...
		            <div class="card-body">
		                ...
		                <div class="row form-group">
		                    ...
		                    <div class="col-md-4">
		                        <input readonly="readonly" value="<?= set_value('tanggal_keluar', date('Y-m-d')); ?>" name="tanggal_keluar" id="tanggal_keluar" type="text" class="form-control date" placeholder="Tanggal Masuk...">
...
<script>
		...
		$("#barang_id").change(function(){
			$('#nama_brg').val($('#barang_id').val().split("_").pop());
