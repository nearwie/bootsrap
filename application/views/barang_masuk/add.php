			    ...
			    <div class="col-md-8">
		            ...
		            <div class="card-body">
		                ...
		                <div class="row form-group">
		                    ...
		                    <div class="col-md-4">
		                        <input readonly="readonly" value="<?= set_value('tanggal_masuk', date('Y-m-d')); ?>" name="tanggal_masuk" id="datepicker" type="text" class="form-control date" placeholder="Tanggal Masuk...">
